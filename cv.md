...
### About myself:
I am 22 years old, recently gratuated bachelor from PSUTI, Samara, Russia. Did learned front-end skills like HTML, CSS, JS in my free time, also worked for some time in a office in web studio. I want to learn front-end further and hope to get job offer.
### Skills:
* __HTML__
* __JavaScript__
